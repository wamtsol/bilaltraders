	...
	<h1 class="title">Manage Customer</h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="customer_manage.php?tab=add" class="btn btn-light editproject">Add New Customer</a> <a id="topstats" class="btn btn-light" href="#"><i class="fa fa-search"></i></a> 
        </div>
  	</div>
</div>
	...
	<table class="table table-hover list">
    	...
    	<tbody>
            ...
            if(numrows($rs)>0){
                $sn=1;
                while($r=dofetch($rs)){     
                    $total_balance += get_customer_balance( $r[ "id" ] );        
                    ?>
                    <tr>
                        ...
                        <td class="text-right">
                        	<?php
                            echo curr_format( get_customer_balance( $r[ "id" ] ) );
							?>
                        </td>
                ...
                <tr>
                    ...
                    <td colspan="8" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "customer", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
