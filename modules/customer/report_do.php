...
if( isset($_GET["order_by"]) ){
	$_SESSION["customer_manage"]["report"]["order_by"]=slash($_GET["order_by"]);
}
if( isset( $_SESSION["customer_manage"]["report"]["order_by"] ) ){
	$order_by = $_SESSION["customer_manage"]["report"]["order_by"];
}
if( isset($_GET["order"]) ){
	$_SESSION["customer_manage"]["report"]["order"]=slash($_GET["order"]);
}
if( isset( $_SESSION["customer_manage"]["report"]["order"] ) ){
	$order = $_SESSION["customer_manage"]["report"]["order"];
}
