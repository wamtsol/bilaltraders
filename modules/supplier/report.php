	...
	<h1 class="title"><?php echo $supplier["supplier_name"]?></h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
            ...
            <a class="btn print-btn" href="supplier_manage.php?tab=print&id=<?php echo $supplier["id"];?>"><i class="fa fa-print" aria-hidden="true"></i></a> 
	...
	<table class="table table-hover list">
    	<thead>
            <tr>
                ...
                <th>
                    <a href="supplier_manage.php?tab=report&id=<?php echo $supplier["id"]?>order_by=date&order=<?php echo $order=="asc"?"desc":"asc"?>" class="sorting">
                        Date
                        <?php
                        if( $order_by == "date" ) {
                            ?>
