...
if(isset($_POST["supplier_add"])){
	...
	if($err==""){
		$sql="INSERT INTO supplier (supplier_name, phone, address, balance, supplier_code) VALUES ('".slash($supplier_name)."','".slash($phone)."','".slash($address)."', '".slash($balance)."', '".slash($supplier_code)."')";
		doquery($sql,$dblink);
