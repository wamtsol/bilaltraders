                            ...
                            if(count($items)>0){
                                foreach($items as $item){
                                    ...
                                    <tr class="purchase_item">
                                        ...
                                        <td>
                                        	<input type="text" name="items[<?php echo $sn?>][item_name]" id="item_name<?php echo $sn?>" value="<?php echo $item_name?>" />
                                        </td>
                                        <td class="text-right"><input type="text" class="purchase_price" name="items[<?php echo $sn?>][purchase_price]" id="purchase_price<?php echo $sn?>" value="<?php echo $purchase_price?>" /></td>
                                        <td class="text-right"><input type="text" class="sale_price" name="items[<?php echo $sn?>][sale_price]" id="sale_price<?php echo $sn?>" value="<?php echo $sale_price?>" /></td>
                                        ...
                                        <td class="text-right"><input type="text" class="total_price" name="items[<?php echo $sn?>][total_price]"  id="total_price<?php echo $sn?>" value="<?php echo $total_price?>" /></td>                        
